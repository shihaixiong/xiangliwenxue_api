        ...
        $('#example').dataTable({
            ...
            "columnDefs":[
                ...
                },
                {
                    "targets": 6,
                    "data": "keywords",
                    "render": function (data, keywords, row, meta) {
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        var s='<button type="button" class="btn btn-xs btn-warning watch" id="'+row.id+'">查看章节</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-xs btn-warning edit" id="'+row.id+'">编辑</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-xs bg-red del" id="'+row.id+'">删除</button>';
