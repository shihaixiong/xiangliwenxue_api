...
<div class="col-md-12">
        ...
        <!-- form start -->
        <form action="/admin/share/update" method="post" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" onsubmit="return check(this)">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <input type="text" name="check_title" id="check_title" class="form-control"  placeholder="请输入书名" value="{{$data['book_name']}}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            <input type="text" name="title" id="title" class="form-control" placeholder="请填写推荐语" value="{{$data['title']}}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            <input type="text" name="articleid" id="articleid" class="form-control" placeholder="查询完书id 会自动输入" value="{{$data['articleid']}}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            <input type="text" name="start_num" id="start_num" class="form-control" maxlength="150" value="{{$data['start_num']}}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            <input type="text" name="show_num" id="show_num" class="form-control" value="{{$data['show_num']}}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="select2 form-control" id="style" name="style">
                            <option value="1" @if($data['style'] == 1) selected @endif >有标题</option>
                            <option value="2" @if($data['style'] == 2) selected @endif >无标题</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="select2 form-control" id="language" name="language">
                            <option value="1" @if($data['language'] == 1) selected @endif>简体</option>
                            <option value="2" @if($data['language'] == 2) selected @endif>繁体</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            <input type="text" name="short_rec" id="short_rec" class="form-control" placeholder="" value="{{$data['short_rec']}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            <input type="text" name="start_view_num" id="start_view_num" class="form-control" placeholder='只能填写数字' value="{{$data['start_view_num']}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="my-prove">
                            <img src="{{$data['first_img']}}" class="my-img" style='display: block'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 images" >
                        @foreach($data['oimages']  as  $k=>$v) 
                            <div class="my-prove">
                                <img src="{{$v}}" class="my-img" style='display: block'>
                                <input type="file" name="images[{{$k}}]" class="prove" >
                            </div>
                        @endforeach
                    </div>
                </div>
